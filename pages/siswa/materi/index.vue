...
<div class="flex flex-col h-full px-4 py-4">
    <div class="grid grid-cols-3 gap-3 place-content-between">
        ...
        <img class="rounded-full justify-end col-end-4 place-self-end" :src="`https://ui-avatars.com/api/?name=${nama}&amp;background=4e73df&amp;color=ffffff&amp;size=50`" alt="">
    </div>

    <!-- search bar -->
    <div class="relative z-20 flex items-center w-full h-10 mt-4 rounded-3xl focus-within:shadow-lg bg-sky-100 overflow-hidden">
        ...
        <input class="peer h-full w-full outline-none font-light text-gray-300 pr-2 bg-sky-100" type="text" id="search" placeholder="Cari Materi" />
    ...
    <div class="flex flex-col " :class="{ 'hidden': isMateriVertical }">
        <div v-for="data in dataSample" class="z-10">
            <div v-for="topik in data.topik">
                ...
                <!-- card materi -->
                <div v-for="materi in topik.materi" :key="materi.id + 'index' + topik.nama+materi.nama" class="grid grid-cols-6 drop-shadow-lg border-b-2 mb-2 rounded-xl z-10 bg-white py-3 px-2" @click="toggleSlide">
    ...
    <div class="grid grid-cols-6 mt-2" :class="{ 'hidden': isMateriFlex }">
        <div v-for="index in materis" :key="index.id + 'index2'" class="flex flex-col col-span-2 bg-white mx-1 mt-2 z-10 drop-shadow-xl rounded-xl px-2 py-2" @click="toggleSlide">
        ...
        <div class="fixed inset-0 overflow-hidden">
            <div class="absolute inset-0 overflow-hidden">
                <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full ">
                    ...
                    <div class="pointer-events-auto relative w-screen max-w-md transform transition ease-in-out duration-500 sm:duration-700 translate-x-full" :class="{ 'translate-x-0': slideOver }">
                        <div class="absolute top-0 left-0 -ml-8 flex pt-4 pr-2 sm:-ml-10 sm:pr-4">
                            <button @click="toggleSlide" type="button" class="rounded-md text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-sky-100 pt-4 shadow-xl">
                            <div class="px-4 grid grid-cols-4 sm:px-6">
                                <div class="back-button col-span-1 justify-self-start place-self-center" @click="toggleSlide">
                                    <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 1L1 9L9 17" stroke="#56739D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>

                                <h2 class="text-lg text-center col-start-2 col-span-2 place-self-center text-cyan-800 font-semibold" id="slide-over-title">Materi</h2>
                                <div class="img-decor">
