...
<div class="flex flex-col h-full px-4 py-4">
    ...
    <div class="bar-select grid grid-cols-10 mt-4 z-20">
        ...
        <div class="relative inline-block text-left col-span-4 mr-2 z-20">
            <div>
                <button @click="onDropdownClassClicked" type="button" class="inline-flex w-full justify-center rounded-2xl border border-gray-300 bg-sky-100 px-4 py-1 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-sky-100" id="menu-button" aria-expanded="true" aria-haspopup="true">
                    Kelas
            ...
            <div class="absolute z-auto mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" style="z-index: 999;" :class="{ 'hidden': dropdownClassClicked == false }" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                <div class="py-1" role="none">
                    <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                    <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Kelas 4</a>
                </div>
                <div class="py-1" role="none">
                    <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Kelas 5</a>

                </div>
                <div class="py-1" role="none">
                    <a href="#" class="text-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-4">Kelas 6</a>
