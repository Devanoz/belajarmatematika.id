...
export default {
  ...
  async asyncData ({
    ...
    await store.dispatch('teacher/topik/getDetailTopik', route.query.topik)
  },
  ...
  methods: {
    ...
    async storeMateri () {
      ...
      await this.$store.dispatch('teacher/materi/updateMateri', {
        materiId: this.$route.query.materi,
        payload: formData
      })
        //success
        .then(() => {
